            ...
            <div class="row">
                ...
                <div class="container">
                    ...
                    <div id="Info" class="tabcontent">
                        ...
                        <div class="row">
                            <div class="column">
                                <h7 class="bold">Ici vous pouvez voir les différentes informations qui sont susceptibles
                                    de varier avec les années
                                </h7>
                            </div>
                        </div>
                        <div class="row medium-up-2">
                            <div class="column">
                                <p>Pour modifier les valeurs, rien de plus simple ! Vous n'avez qu'à modifier la valeur
                                    dans la case et cliquer sur le bouton "Modifier"</p>
                            </div>
                            <div class="column">
                                <div class="cube"></div>
                            </div>
                            ...
                            <div class="column infos">
                                ...
                                <form method="get" action="update.php">
                                    ...
                                    while ($donnees1 = $p_reponse1->fetch()) {
                                        ?>
                                        <span class="bold">DATE DEBUT : </span><input type="text"
                                                                                      name="bacplus3idracDateDebut"
                                                                                      value="<?php echo $donnees1['dateDebut']; ?>">
                                        <span class="bold">DATE FIN : </span><input type="text"
                                                                                    name="bacplus3idracDateFin"
                                                                                    value="<?php echo $donnees1['dateFin']; ?>">
                                        <span class="bold">INTITULE FORMATION : </span><input type="text"
                                                                                              name="bacplus3idracIntitule"
                                                                                              value="<?php echo $donnees1['intitule']; ?>">
                                        <span class="bold">NOM DIPLOME : </span><input type="text"
                                                                                       name="bacplus3idracDiplome"
                                                                                       value="<?php echo $donnees1['diplome']; ?>">
                                        <span class="bold">CALENDRIER : </span><input type="text"
                                                                                      name="bacplus3idracCalendrier"
                                                                                      value="<?php echo $donnees1['calendrier']; ?>">
                                        <span class="bold">TARIF FORMATION : </span><input type="text"
                                                                                           name="bacplus3idracTarif"
                                                                                           value="<?php echo $donnees1['tarifFormation']; ?>">
                                        <span class="bold">COUT FORMATION : </span><input type="text"
                                                                                          name="bacplus3idracCout"
                                                                                          value="<?php echo $donnees1['coutFormation']; ?>">
                                        <span class="bold">COUT HORAIRE : </span><input type="text"
                                                                                        name="bacplus3idracHoraire"
                                                                                        value="<?php echo $donnees1['coutHoraire']; ?>">
                                        <input type="hidden" name="bacplus3idracId"
                                               value="<?php echo $donnees1['id']; ?>">
                                    <?php } ?>
                            </div>
                            <div class="column infos">
                                <h5>BAC +4/5</h5>
                                ...
                                while ($donnees1 = $p_reponse1->fetch()) {
                                    ?>
                                    <span class="bold">DATE DEBUT : </span><input type="text"
                                                                                  name="bacplus45idracDateDebut"
                                                                                  value="<?php echo $donnees1['dateDebut']; ?>">
                                    <span class="bold">DATE FIN : </span><input type="text" name="bacplus45idracDateFin"
                                                                                value="<?php echo $donnees1['dateFin']; ?>">
                                    <span class="bold">INTITULE FORMATION : </span><input type="text"
                                                                                          name="bacplus45idracIntitule"
                                                                                          value="<?php echo $donnees1['intitule']; ?>">
                                    <span class="bold">NOM DIPLOME : </span><input type="text"
                                                                                   name="bacplus45idracDiplome"
                                                                                   value="<?php echo $donnees1['diplome']; ?>">
                                    <span class="bold">CALENDRIER : </span><input type="text"
                                                                                  name="bacplus45idracCalendrier"
                                                                                  value="<?php echo $donnees1['calendrier']; ?>">
                                    <span class="bold">TARIF FORMATION : </span><input type="text"
                                                                                       name="bacplus45idracTarif"
                                                                                       value="<?php echo $donnees1['tarifFormation']; ?>">
                                    <span class="bold">COUT FORMATION : </span><input type="text"
                                                                                      name="bacplus45idracCout"
                                                                                      value="<?php echo $donnees1['coutFormation']; ?>">
                                    <span class="bold">COUT HORAIRE : </span><input type="text"
                                                                                    name="bacplus45idracHoraire"
                                                                                    value="<?php echo $donnees1['coutHoraire']; ?>">
                        ...
                        <div class="row medium-up-3 small-up-1 large-up-3" style="text-align:-moz-center;">
                            <div class="column infos">
                                ...
                                while ($donnees1 = $p_reponse1->fetch()) {
                                    ?>
                                    <span class="bold">DATE DEBUT : </span><input type="text"
                                                                                  name="bacplus3sdcDateDebut"
                                                                                  value="<?php echo $donnees1['dateDebut']; ?>">
                                    <span class="bold">DATE FIN : </span><input type="text" name="bacplus3sdcDateFin"
                                                                                value="<?php echo $donnees1['dateFin']; ?>">
                                    <span class="bold">INTITULE FORMATION : </span><input type="text"
                                                                                          name="bacplus3sdcIntitule"
                                                                                          value="<?php echo $donnees1['intitule']; ?>">
                                    <span class="bold">NOM DIPLOME : </span><input type="text" name="bacplus3sdcDiplome"
                                                                                   value="<?php echo $donnees1['diplome']; ?>">
                                    <span class="bold">CALENDRIER : </span><input type="text"
                                                                                  name="bacplus3sdcCalendrier"
                                                                                  value="<?php echo $donnees1['calendrier']; ?>">
                                    <span class="bold">TARIF FORMATION : </span><input type="text"
                                                                                       name="bacplus3sdcTarif"
                                                                                       value="<?php echo $donnees1['tarifFormation']; ?>">
                                    <span class="bold">COUT FORMATION : </span><input type="text" name="bacplus3sdcCout"
                                                                                      value="<?php echo $donnees1['coutFormation']; ?>">
                                    <span class="bold">COUT HORAIRE : </span><input type="text"
                                                                                    name="bacplus3sdcHoraire"
                                                                                    value="<?php echo $donnees1['coutHoraire']; ?>">
                            ...
                            <div class="column infos">
                                ...
                                while ($donnees1 = $p_reponse1->fetch()) {
                                    ?>
                                    <span class="bold">DATE DEBUT : </span><input type="text"
                                                                                  name="bacplus45sdcDateDebut"
                                                                                  value="<?php echo $donnees1['dateDebut']; ?>">
                                    <span class="bold">DATE FIN : </span><input type="text" name="bacplus45sdcDateFin"
                                                                                value="<?php echo $donnees1['dateFin']; ?>">
                                    <span class="bold">INTITULE FORMATION : </span><input type="text"
                                                                                          name="bacplus45sdcIntitule"
                                                                                          value="<?php echo $donnees1['intitule']; ?>">
                                    <span class="bold">NOM DIPLOME : </span><input type="text"
                                                                                   name="bacplus45sdcDiplome"
                                                                                   value="<?php echo $donnees1['diplome']; ?>">
                                    <span class="bold">CALENDRIER : </span><input type="text"
                                                                                  name="bacplus45sdcCalendrier"
                                                                                  value="<?php echo $donnees1['calendrier']; ?>">
                                    <span class="bold">TARIF FORMATION : </span><input type="text"
                                                                                       name="bacplus45sdcTarif"
                                                                                       value="<?php echo $donnees1['tarifFormation']; ?>">
                                    <span class="bold">COUT FORMATION : </span><input type="text"
                                                                                      name="bacplus45sdcCout"
                                                                                      value="<?php echo $donnees1['coutFormation']; ?>">
                                    <span class="bold">COUT HORAIRE : </span><input type="text"
                                                                                    name="bacplus45sdcHoraire"
                                                                                    value="<?php echo $donnees1['coutHoraire']; ?>">
                            ...
                            <div class="column infos">
                                ...
                                while ($donnees1 = $p_reponse1->fetch()) {
                                    ?>
                                    <span class="bold">DATE DEBUT : </span><input type="text"
                                                                                  name="bacplus5sdcDateDebut"
                                                                                  value="<?php echo $donnees1['dateDebut']; ?>">
                                    <span class="bold">DATE FIN : </span><input type="text" name="bacplus5sdcDateFin"
                                                                                value="<?php echo $donnees1['dateFin']; ?>">
                                    <span class="bold">INTITULE FORMATION : </span><input type="text"
                                                                                          name="bacplus5sdcIntitule"
                                                                                          value="<?php echo $donnees1['intitule']; ?>">
                                    <span class="bold">NOM DIPLOME : </span><input type="text" name="bacplus5sdcDiplome"
                                                                                   value="<?php echo $donnees1['diplome']; ?>">
                                    <span class="bold">CALENDRIER : </span><input type="text"
                                                                                  name="bacplus5sdcCalendrier"
                                                                                  value="<?php echo $donnees1['calendrier']; ?>">
                                    <span class="bold">TARIF FORMATION : </span><input type="text"
                                                                                       name="bacplus5sdcTarif"
                                                                                       value="<?php echo $donnees1['tarifFormation']; ?>">
                                    <span class="bold">COUT FORMATION : </span><input type="text" name="bacplus5sdcCout"
                                                                                      value="<?php echo $donnees1['coutFormation']; ?>">
                                    <span class="bold">COUT HORAIRE : </span><input type="text"
                                                                                    name="bacplus5sdcHoraire"
                                                                                    value="<?php echo $donnees1['coutHoraire']; ?>">
