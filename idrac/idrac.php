  ...
  ?>
            <a href="index.php"><h1>FORMULAIRE BAC +3</h1></a>
          </div>
        </div>
        <div class="row">
          <div class="column">
            <h1 id="title">FICHE DE RENSEIGNEMENT</h1><img src="../img/idrac-exec.png" style="max-height:150px;"></img>
          ...
          <div class="container">
                ...
                <div class="column">
                  <div class="border">
                    ...
                    <p><span class="bold">Intitulé de la formation</span> : <?php echo $donnees['intitule']; ?><br />
                      <span class="bold">Titre RNCP</span> : <?php echo $donnees['diplome']; ?> <br />
                      ...
                      <span class="bold">Volume horaire: </span>560 heures <span class="bold">Coût total: </span><?php echo $donnees['coutFormation']; ?>€ HT <span class="bold">Coût horaire : </span><?php echo $donnees['coutHoraire']; ?>€ HT
                    </p>
                  </div>
                </div>
                <div class="column">
            ...
            <div id="Formulaire" class="tabcontent">
              <form method="get" action="idracpost.php">
...
TITRE: <input type="text" name="titre1" id="titre1"> NOM: <input type="text" name="nom-apprenant" id="nom-apprenant"> PRENOM: <input type="text" name="prenom" id="prenom-apprenant"> FORMATION: <input type="text" name="formation" id="formation">              </div>
            </div>
            <div class="column">
              <div class="block">
                <div class="header">
            ...
            <div class="column">
              <div class="block">
                ...
                <span>VOTRE OCPA : </span><input type="text" name="OCPA" id="OCPA"><br />
            ...
            <div class="row large-up-2">
              ...
              <div class="column">
                <div class="block">
                  ...
                  <span>ADRESSE : <br /></span><span class="etab1">ETABLISSEMENT 1 <input type="checkbox" name="etab61" id="etab61"></span><span class="etab2"> ETABLISSEMENT 2 <input type="checkbox" name="etab62" id="etab62"></span>
                </div>
              </div>
            </div>
            <div class="row large-up-2">
              <div class="column">
                <input type="submit" name="annuler" id="annuler" value="Annuler" class="button"><span> </span><input type="submit" name="soumettre" id="soumettre" value="Soumettre" class="button">
              </div>
            </div>
          </div>
        </div>
