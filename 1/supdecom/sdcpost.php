...
***/
  ...
  $last=$bdd->query('SELECT numContrat from absences ORDER BY numContrat DESC LIMIT 1');
...
*\ contratpro contient les informations concernant le contrat de professionnalisation
  **/
  ...
  $p_requete1= $bdd->prepare('insert into apprenant (numContrat,  nom, prenom, titre) VALUES (:numContrat, :nom, :prenom, :titre)');
  ...
  $p_requete3=$bdd->prepare('insert into financement (numContrat, adresse1, adresse2, commentaire, cp, ville, ocpa, subrogation, formation) VALUES (:numContrat, :adresse1, :adresse2, :commentaire, :cp, :ville, :ocpa, :subrogation, :formation)');
  ...
  $p_requete4=$bdd->prepare('insert into signataire (numContrat, adresse, cp, effectif, NAF, raisonSociale, secteurActivite, SIRET, telephone, ville) VALUES (:numContrat, :adresse, :CP, :effectif, :NAF, :raisonSociale, :secteurActivite, :SIRET, :telephone, :ville)');
  ...
  $p_requete5=$bdd->prepare('insert into execution (numContrat, adresse, CP, effectif, NAF, raisonSociale, secteurActivite, SIRET, telephone, ville) VALUES (:numContrat, :adresse, :CP, :effectif, :NAF, :raisonSociale, :secteurActivite, :SIRET, :telephone, :ville)');
  ...
  $p_requete6=$bdd->prepare('insert into tuteur (numContrat, adresse, email, fonction, nom, prenom, telephone, titre) VALUES (:numContrat, :adresse, :email, :fonction, :nom, :prenom, :telephone, :titre)');
  ...
  $p_requete7=$bdd->prepare('insert into signatairecontrat (numContrat, adresse, email, fonction, nom, prenom, telephone, titre) VALUES (:numContrat, :adresse, :email, :fonction, :nom, :prenom, :telephone, :titre)');
  ...
  $p_requete8=$bdd->prepare('insert into administration (numContrat, adresse, email, fonction, nom, prenom, telephone, titre) VALUES (:numContrat, :adresse, :email, :fonction, :nom, :prenom, :telephone, :titre)');
  ...
  $p_requete9=$bdd->prepare('insert into facturation (numContrat, adresse, email, fonction, nom, prenom, telephone, titre) VALUES (:numContrat, :adresse, :email, :fonction, :nom, :prenom, :telephone, :titre)');
  ...
  $p_requete10=$bdd->prepare('insert into absences (numContrat, adresse, email, fonction, nom, prenom, telephone, titre) VALUES (:numContrat, :adresse, :email, :fonction, :nom, :prenom, :telephone, :titre)');
  ...
  $p_requete11=$bdd->prepare('insert into taxeapprentissage (numContrat, adresse, email, fonction, nom, prenom, telephone, titre) VALUES (:numContrat, :adresse, :email, :fonction, :nom, :prenom, :telephone, :titre)');
  ...
  $p_requete2=$bdd->prepare('insert into contratpro (numContrat, contrat, dateDebut, dateFin, dureeHebdo, intitule, remuneration) VALUES (:numContrat, :contrat, :dateDebut, :dateFin, :dureeHebdo, :intitule, :remuneration)');
  ...
  /*Puis on retourne sur la page index.php de supdecom */
